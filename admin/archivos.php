...
<td><strong>Detalles</strong></td>
 ...
 if(empty($_POST['bus'])){
  ...
  <tr>
    <td><?php echo $i; ?></td>
    <td><a href="archivos2.php?id=<?php echo $dato['idexpediente']; ?>"  title="Ver" class=""><?php echo $dato['idexpediente']; ?></a></td>
    ...
    <td><a href="archivos2.php?id=<?php echo $dato['idexpediente']; ?>" title="Ver Detalle" class="btn btn-info">VER</a></td>
  </tr>
  <?php } ?>
  </tbody>
</table>
