...
<td><strong>Acciones</strong></td>
  ...
  <?php
  	...
  	if(empty($_POST['bus'])){
		...
		$buscar=$_POST['bus'];
		$can=mysql_query("SELECT * FROM flujo where area='$sarea' and codep='$sdep' and idexpediente='$buscar' or tramite='$buscar'");
	}
	$i=0;
  ...
  <tr>
	...
	;
	 ...
	 ?></td>
    <td><a href="../admin/l_doc.php?estado=<?php echo $dato['id']; ?>"><?php echo $estado; ?></a></td>
    <td><?php 
