    ...
    <div id="navbar-example" class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container" style="width: auto;">
          ...
          <ul class="nav" role="navigation">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
                <li role="presentation"><a role="menuitem" tabindex="-1" href="c_usuario.php" target="admin">Registrar Usuarios</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="l_usuario.php" target="admin">Listar Usuarios</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
              	<li role="presentation"><a role="menuitem" tabindex="-1" href="c_area.php" target="admin">Registrar Áreas</a></li>
              	<li role="presentation"><a role="menuitem" tabindex="-1" href="l_area.php" target="admin">Listar Areas</a></li>
              </ul>
            </li>
         ...
         <!--Aqui va el tercer menu -->
         <li class="dropdown">
              <a href="#" id="drop2" role="button" class="dropdown-toggle" data-toggle="dropdown">Tipo Doc.<b class="caret"></b></a>
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
              	<li role="presentation"><a role="menuitem" tabindex="-1" href="c_documento.php" target="admin">Registrar Tipo Documento</a></li>
              	<li role="presentation"><a role="menuitem" tabindex="-1" href="l_documento.php" target="admin">Listar Tipo Documento</a></li>
          ...
          <ul class="nav pull-right">
            ...
            <!--AQUI EMPIEZA-->
             <li id="fat-menu" class="dropdown">
              <a href="#" id="drop3" role="button" class="dropdown-toggle" data-toggle="dropdown"> Dependencia: <?php 
			  
			  $sdep=$_SESSION['dependencia'];
	$sql2="select * from dependencia where codigo='$sdep'";
$query2=mysql_query($sql2);
$fila2=mysql_fetch_array($query2);	
	
	
	echo "<STRONG>".$fila2['nombre']."</strong>";
...
$fila=mysql_fetch_array($query);	
  ...
  <tr>
    <td><iframe src="presentacion.php" frameborder="0" scrolling="auto" name="admin" width="100%" height="900"></iframe></td>
  </tr>
  <tr>
    <td>
