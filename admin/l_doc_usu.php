<?php
		...
		if(!$_SESSION['tipo_usu']=='a'){
			...
			if(!empty($_GET['estado'])){
				...
				$sql="UPDATE expediente SET estado='$estado' WHERE id=$codig and";
				mysql_query($sql);
			}
		}
?>
...
<td><strong>Acciones</strong></td>
  ...
  <?php
  	...
  	if(empty($_POST['bus'])){
		...
		$buscar=$_POST['bus'];
		$can=mysql_query("SELECT * FROM expediente where idexpediente LIKE '$buscar%' or tramite LIKE '$buscar%'");
	}
	$i=0;
  ...
  <tr>
	...
	;
	 ...
	 ?></td>
    <td><a href="../admin/l_doc_usu.php?estado=<?php echo $dato['id']; ?>"><?php echo $estado; ?></a></td>
    <td><?php 
