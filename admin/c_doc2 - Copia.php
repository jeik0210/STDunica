  ...
  <tr>
    <td colspan="3"><?php
		...
		$descripcion=$_POST['descripcion'];
			...
			if($boton=='Actualizar'){
				$xSQL="Update flujo Set idexpediente='$nombre',area='$area',folios='$folios',remite='$remite',asunto='$asunto'
							Where id=$id";
				mysql_query($xSQL);
			...
			//REGISTRAR DATOS DEL DOCUMENTO		
					...
					//TABLA EXPEDIENTE
						$sql = "INSERT INTO expedientee (idexpediente,tramite,fecha,hora,fechas,tipodoc,ndoc,folios,procedencia,dependencia,asunto,descripcion,area,estado) VALUES ('$nombre','$tramite','$fecha','$hora','$fechas','$tipodoc','$ndoc','$folios','$procedencia','$dependencia','$asunto','$descripcion','12','s')";
						//TABLA FLUJO
					$sql2 = "INSERT INTO flujoe (idexpediente,tramite,fecha,hora,fechas,tipodoc,ndoc,folios,procedencia,dependencia,asunto,descripcion,area,estado) VALUES ('$nombre','$tramite','$fecha','$hora','$fechas','$tipodoc','$ndoc','$folios','$procedencia','$dependencia','$asunto','$descripcion','12','s')";
