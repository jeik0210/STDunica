  ...
  <body data-spy="scroll" data-target=".bs-docs-sidebar">
  	<div align="right">
  		<form name="form1" method="post" action="">
  			<a href="c_doc3.php" class="btn btn-info"><i class="icon-user"></i> Nuevo Documento</a>
	...
	//PARA MOSTRAR LOS DIAS TRANSCURRIDOS
  						...
  						<td><?php 
  							...
  							<td><?php 
  								...
  								<td><a href="c_doc3.php?id=<?php echo $dato['id']; ?>" title="Editar Documento" class="btn btn-info"><i class="icon-pencil"></i></a></td>
  							</tr>
  							<?php } ?>
  						</tbody>
  					</table>
