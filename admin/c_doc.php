<?php
		...
		//varaible sesionada del campo dependencia de la tabla usuario
...
<blockquote>
 <a href="l_doc.php" class="btn btn-info"><i class="icon-list-alt"></i>Ir Listado de Documentos</a>
 </blockquote>
<div align="center">
  ...
  <tr>
    <td colspan="3"><?php
		...
		$descripcion=$_POST['descripcion'];
			...
			if($boton=='Actualizar'){
				$xSQL="Update flujo Set idexpediente='$nombre',fecha='$fecha',hora='$hora',tipodoc='$tipodoc',ndoc='$ndoc',folios='$folios',procedencia='$procedencia',dependencia='$dependencia',asunto='$asunto',descripcion='$descripcion',folios='$folios'
							Where id=$id";
				mysql_query($xSQL);
			...
			//REGISTRAR DATOS DEL DOCUMENTO		
					...
					//TABLA EXPEDIENTE
						$sql = "INSERT INTO expediente (idexpediente,tramite,fecha,hora,tipodoc,ndoc,folios,procedencia,dependencia,asunto,descripcion,area,codep,estado) VALUES ('$nombre','$tramite','$fecha','$hora','$tipodoc','$ndoc','$folios','$procedencia','$dependencia','$asunto','$descripcion','12','$sdep','s')";
						//TABLA FLUJO
					$sql2 = "INSERT INTO flujo (idexpediente,tramite,fecha,hora,tipodoc,ndoc,folios,procedencia,dependencia,asunto,descripcion,area,codep,estado) VALUES ('$nombre','$tramite','$fecha','$hora','$tipodoc','$ndoc','$folios','$procedencia','$dependencia','$asunto','$descripcion','12','$sdep','s')";
